...
public class ILPSolver {
	...
	public static void createCommandFile(File lpfile,File solfile) {
		try {
			...
			pw.write("set mip pool absgap 0\r\n");
			pw.write("set mip pool intensity 4\r\n");
			pw.write("set mip limits populate 2100000000\r\n");
			...
			pw.write("y"+"\"\r\n");
			pw.close();
			System.out.println("set mip pool absgap 0\r\n");
			System.out.println("set mip pool intensity 4\r\n");
			System.out.println("set mip limits populate 2100000000\r\n");
			System.out.println("read \""+lpfile.getAbsolutePath()+"\"\r\n");
			System.out.println("optimize\r\n");
			System.out.println("write \""+solfile.getAbsolutePath()+"\"\r\n");
